                    ...
                    <div className="main-content main-content-table overflow-auto">
                        <table className="table table-borderless">
                            ...
                            <tbody>
                               ...
                               <TableRow image="overview-2" title="Call of Duty:Modern" category="Desktop" item={500} price={740000} status="Success" />
                               <TableRow image="overview-3" title="Clash of Clans" category="Mobile" item={500} price={740000} status="Success" />
